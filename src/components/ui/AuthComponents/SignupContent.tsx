...
function SignupContent({ signUpForm, handleClose, switchToSignIn }: SignupContentProps) {
    ...
    return (
        <div className="w-full flex-shrink-0 space-y-6">
            ...
            <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                    <Label htmlFor="signup-last_name" className="text-right">Name</Label>
                    <div className="col-span-3 space-y-1">
                        <Input
                            id="signup-last_name"
                            type="text"
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                    <Label htmlFor="signup-phone" className="text-right">Phone</Label>
                    <div className="col-span-3 space-y-1">
                        <Input
                            id="signup-phone"
                            type="tel"
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                    <Label htmlFor="signup-confirm-password" className="text-right">Confirm</Label>
                    <div className="col-span-3 space-y-1">
                        <Input
