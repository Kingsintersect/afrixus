        ...
        >
            <div className="relative w-full h-[250px] overflow-hidden bg-gray-100">
                {product.picture && (
                    <Image
                        ...
                        src={"/products/ankara/ankara-1.jpg"}
                        // src={product.picture?.[0]?.image || "/products/ankara/ankara-1.jpg"}
            ...
            <div className="p-4 space-y-5">
                ...
                <p className="mt-2 text-lg font-bold text-red-600">
                    {!isNaN(Number(product.price1)) ? formatCurrency(Number(product.price1), "NGN") : formatCurrency(0, "NGN")}
                </p>
            </div>
