...
async function ProductPage({
    ...
    return (
        <div className='conatainer mx-auto px-4 py-8 mr-20'>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className={`relative aspect-square overflow-hidden rounded-lg shadow-lg`}>
                    {product.picture && (
                        <Image
                            src={imageUrl(product.picture[0])}
                ...
                <div className="flex flex-col justify-between">
                    <div className="flex flex-col mt-10">
                        ...
                        <div className="text-xl font-semibold mb-4 space-x-5">
                            ...
                            <span className="text-red-400">{formatCurrency(Number(product.price1), "NGN")}</span>
                        </div>
