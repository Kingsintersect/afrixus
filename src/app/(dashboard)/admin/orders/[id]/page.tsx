...
import { getCustomerOrderDetailsById } from '@/actions/ordersAction';
...
const OrderDetailspage = (props: { params: Promise<{ id: number }> }) => {
    ...
    const { data: orderDetails, isLoading } = useQuery({
        ...
        queryFn: async () => {
            const orders = await getCustomerOrderDetailsById(id);
